...
import (
	"bytes"
	"errors"
	"github.com/devashishRaj/goTools/pipeline"
...
func TestFromFile_GivenNonExistentFile(t *testing.T) {
	t.Parallel()
...
func TestString_ReturnsPipeContent(t *testing.T) {
	t.Parallel()
	want := "Hello"
	p := pipeline.FromString(want)
	got, err := p.String()
...
func TestColumn_SelectColumn2Of3(t *testing.T) {
	t.Parallel()
	input := "1 2 3\n1 2 3\n1 2 3\n"
